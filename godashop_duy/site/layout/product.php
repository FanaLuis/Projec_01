<div class="product-container">
    ...
    <div class="product-meta">
        <h5 class="name">
            <a class="product-name" href="index.php?c=product&a=show&id=<?=$product ->getId()?>" title="<? $product->getName() ?>"><?= $product->getName() ?></a>
        </h5>
    ...
    <div class="button-product-action clearfix">
        ...
        <div class="quickview icon">
            <a class="btn btn-outline-inverse" href="index.php?c=product&a=show&id=<?=$product ->getId()?>" title="<? $product->getName() ?>" title="Xem nhanh">
